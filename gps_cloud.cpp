...
* 6. Stores data offline when network is unavailable
...
const char* ssid = "TU_WIFI";      // Your WiFi network name (SSID)
const char* password = "TU_PASSWORD"; // Your WiFi network password
// ==================================================================
//                   GEOLINKER CONFIGURATION
// ==================================================================
// API Authentication
const char* apiKey = "TU_API_KEY";   // Your unique GeoLinker API key
